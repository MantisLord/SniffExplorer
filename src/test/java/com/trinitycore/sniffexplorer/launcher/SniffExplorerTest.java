...
public class SniffExplorerTest {
    ...
    public void testFillGlobalUnitBRadiusCReachMap_1() throws Exception {
        ...
        HashMap<Unit, Map<LocalDateTime, Double>> globalCombatReachMap = new HashMap<>();
        HashMap<Unit, Map<LocalDateTime, Double>> globalBoundingRadiusMap = new HashMap<>();
        ...
        Map<LocalDateTime, Double> changesMap1 = globalCombatReachMap.get(new Creature(49743, "0xF130C24F0009C932"));
        Map<LocalDateTime, Double> changesMap2 = globalCombatReachMap.get(new Creature(44158, "0xF130AC7E0000208B"));
        Map<LocalDateTime, Double> changesMap3 = globalCombatReachMap.get(new Creature(20491, "0xF130500B0000667E"));
        ...
        Map<LocalDateTime, Double> changesMap4 = globalBoundingRadiusMap.get(new Player("Gansinolo", "0x60000000320D4F0"));
        Assert.assertNotNull(changesMap1);
        Assert.assertNotNull(changesMap2);
        Assert.assertNotNull(changesMap3);
