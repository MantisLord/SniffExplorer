...
**If you are starting here and wish to understand how the project works**, I recommend that you start by reading [the life cycle of the application](http://github.com) and then look at the class diagram and the “todo” list in the analysis folder: https://github.com/chaodhib/SniffExplorer/tree/master/Analysis%20Documents
